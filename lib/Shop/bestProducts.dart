...
class bestProductsSpinner extends StatefulWidget {
  const bestProductsSpinner({Key? key}) : super(key: key);

  @override
  State<bestProductsSpinner> createState() => _allbestProductsSpinnerState();
}

class _allbestProductsSpinnerState extends State<bestProductsSpinner> {
  String? language;
  ...
  {
    try {
      var url = Uri.parse("https://agrinfo.000webhostapp.com/showBestProducts.php");
      ...
      if (response.body.isNotEmpty) {
        ...
        if(shopAllProductsData != null){
          ...
          Navigator.pushNamed(context,'/bestProducts',arguments: shopAllProductsData);
        }
  ...
  Widget build(BuildContext context) {
    ...
    var title = "Shop Best Products";
    if(data == "marathi")
      {
        title = "सर्वोत्तम उत्पादने";
      }
    if(data == "hindi" )
      {
        title = "सर्वोत्तम उत्पाद";
      }
    return WillPopScope(
        onWillPop: () async {
