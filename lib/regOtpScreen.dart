...
class regOtpScreen extends StatefulWidget {
  @override
  _regOtpScreenState createState() => _regOtpScreenState();
}
...
class _regOtpScreenState extends State<regOtpScreen> {
  ...
  Future getUserData() async
  {
    ...
    name = prefUserProfile.getString("UserName");
    mob = prefUserProfile.getString("UserMob");
    email = prefUserProfile.getString("UserEmail");
    state = prefUserProfile.getString("UserState");
  }

  Future registerUser() async
  {
    try {
      var url = Uri.parse("https://agrinfo.000webhostapp.com/register.php");
      ...
      if(data == "false")
      {
        ...
        showDialog(
            ...
            builder: (BuildContext context) {
              return AlertDialog(
                title: Text('Error'),
                content: Text('Enable to Register..'),
                actions: <Widget>[
                  TextButton(
                    child: Text('OK'),
                    onPressed: () {
            ...
            children: [
              ...
              TextButton(onPressed: () async {
                try{
                  ...
                  PhoneAuthCredential credential = PhoneAuthProvider.credential(verificationId: RegistrationFormState.verify, smsCode: phoneCode);
                ...
                child: Padding(
                  ...
                  child: Text("Verify",style: TextStyle(color: Colors.white,letterSpacing: 1),),
                ),),
